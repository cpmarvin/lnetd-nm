...
class Ui_Group_Widget(QtWidgets.QDialog):
    ...
    def retranslateUi(self, L1_Widget):
        ...
        L1_Widget.setWindowTitle(_translate("L1_Widget", "Group Topology"))
