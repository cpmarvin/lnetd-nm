...
class Ui_NetworkInfoForm(object):
    ...
    def setupUi(self, NetworkInfoForm, graph):
        ...
        NetworkInfoForm.resize(511, 389)
        ...
        self.DemandTable.setRowCount(5)
        self.DemandTable.setColumnCount(3)
        self.DemandTable.setObjectName("DemandTable")
        self.DemandTable.horizontalHeader().setVisible(False)
        ...
        self.LinkTable = QtWidgets.QWidget()
        self.LinkTable.setObjectName("LinkTable")
        self.NetworkInforTab.addTab(self.LinkTable, "")
        ...
        self.NetworkInforTab.setCurrentIndex(1)
    ...
    def retranslateUi(self, NetworkInfoForm):
        ...
        self.NetworkInforTab.setTabText(self.NetworkInforTab.indexOf(self.LinkTable), _translate("NetworkInfoForm", "Links"))
